	...
	<div class="sidebar-scroll">
		...
		<div class="sidebar-content">
			...
			<ul class="sidebar-nav">
				...
				<li>
					<a href="{base_url('administrator/collections/')}"><i class="fa fa-pencil-square-o sidebar-nav-icon"></i>Collections</a>
				</li>
				<li>
					<a href="{base_url('administrator/gallery/')}"><i class="fa fa-pencil-square-o sidebar-nav-icon"></i>Gallery</a>
				</li>
				<li>
					<a href="{base_url('administrator/press/')}"><i class="fa fa-pencil-square-o sidebar-nav-icon"></i>Press</a>
				</li>
				<!--<li>
