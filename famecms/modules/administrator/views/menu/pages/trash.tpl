    ...
    <div class="table-responsive">
       <table id="example-datatable" class="table table-vcenter table-condensed">
            ...
            <tr>
                ...
                <td class="text-center">
                    <div class="btn-group">
                        <a ng-click="restoreAction({$i.id_post})" data-toggle="tooltip" title="Restore" class="btn btn-xs btn-default"><i class="fa fa-recycle"></i> </a>
						<a ng-click="deletePermanentAction({$i.id_post})" data-toggle="tooltip" title="Delete Permanent" class="btn btn-xs btn-danger"><i class="fa fa-trash-o"></i> </a>
					</div>
                </td>
            </tr>
            {/foreach}
